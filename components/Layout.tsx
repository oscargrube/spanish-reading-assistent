    ...
    <div className="min-h-screen flex flex-col bg-[#FDFBF7]">
      <header className="bg-[#FDFBF7]/90 backdrop-blur-xl border-b border-[#EAE2D6] sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-20 flex justify-between items-center">
          ...
          <nav className="flex items-center bg-[#2C2420]/5 p-1.5 rounded-2xl border border-[#2C2420]/5">
            <button 
      ...
      <main className={`flex-grow p-6 w-full mx-auto ${currentView === AppView.ANALYZE ? 'max-w-6xl' : 'max-w-4xl'}`}>
        {children}
      </main>
    </div>
  );
